/*
	Describe: draw dynamic picture about snow down
	Author: Leoh
	Data: 2024/6/5
*/
...
int main()
{
	...
	/* 将我们自己设置的着色器文本传进来 */
	Shader ourShader = Shader("shaders/shader_v_4.txt", "shaders/shader_f_4.txt");		// 相对路径
	...
	/* 读取纹理 */
	int width, height;
	unsigned char* image_1 = SOIL_load_image("picture/T_snow1.png", &width, &height, 0, SOIL_LOAD_RGBA);			// 获取图片
	cout << "width = " << width << ", height = " << height << endl;
	unsigned char* image_2 = SOIL_load_image("picture/T_snow2.png", &width, &height, 0, SOIL_LOAD_RGBA);
	cout << "width = " << width << ", height = " << height << endl;
