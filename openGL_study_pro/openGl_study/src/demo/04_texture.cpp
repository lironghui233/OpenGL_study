...
//};
//unsigned char* image = SOIL_load_image("T_image33.png", &width, &height, 0, SOIL_LOAD_RGBA);			// 获取图片
...
unsigned char* image = SOIL_load_image("picture/T_image3.png", &width, &height, 0, SOIL_LOAD_RGBA);			// 获取图片
...
int main()
{
	...
	/* 将我们自己设置的着色器文本传进来 */
	Shader ourShader = Shader("shaders/shader_v_3.txt", "shaders/shader_f_3.txt");		// 相对路径
