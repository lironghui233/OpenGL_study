...
#include"GL/glew.h"							// 根据自己的配置情况进行调整
...
int main()
{
	...
	/* 将我们自己设置的着色器文本传进来 */
	Shader ourShader = Shader("shaders/shader_v_7.txt", "shaders/shader_f_7.txt");		// 相对路径
	Shader lightShader = Shader("shaders/light_v.txt", "shaders/light_f.txt");		// 相对路径
